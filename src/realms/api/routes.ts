...
export const profilePhotosV2Route = createRoute({
  method: 'get',
  path: '/2/profile/{handle}/photos',
  summary: 'List posts with photos for a user',
  request: {
    params: z.object({
      handle: z.string().openapi({
        description:
  ...
  responses: {
    200: {
      description: 'Photo timeline page',
      content: { 'application/json': { schema: APISearchResultsSchema } }
    },
    400: {
      description: 'Invalid path or query parameters',
...
export const profileVideosV2Route = createRoute({
  method: 'get',
  path: '/2/profile/{handle}/videos',
  summary: 'List video posts for a user',
  request: {
    params: z.object({
      handle: z.string().openapi({
        description:
  ...
  responses: {
    200: {
      description: 'Video timeline page',
      content: { 'application/json': { schema: APISearchResultsSchema } }
    },
    400: {
      description: 'Invalid path or query parameters',
